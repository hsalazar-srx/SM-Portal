...
import { H2, H3, Display, Body, Muted, Code, Caption } from '@/components/ui/typography';
    ...
    <div className="min-h-screen bg-bg text-text flex flex-col">
      ...
      <header className="sticky top-0 z-sticky bg-bg border-b border-outline shadow-sm">
        <div className="max-w-7xl mx-auto px-md lg:px-lg h-16 flex items-center justify-between">
          <div>
            <H3 className="text-primary m-0 tracking-tight font-bold">Scanfil Melbourne Portal</H3>
            <Caption className="text-text-weak">Secure M3 Endpoint Access</Caption>
          </div>
          <nav className="flex items-center gap-md">
            ...
            <span className="text-body-sm text-text-weak">{user.displayName}</span>
            <Button 
              variant="secondary" 
              onClick={signOut}
      ...
      <div className="flex-1">
        ...
        <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white">
          <div className="max-w-7xl mx-auto px-md lg:px-lg py-xl">
            <Display className="text-white m-0 mb-md font-bold">
              Welcome, {firstName}! 👋
            </Display>
            <Body className="text-white opacity-90 text-lg">
              You have access to <strong>{user.roles.length}</strong> role(s): {user.roles.join(', ')}
            </Body>
          </div>
        </div>

        {/* Authentication Info */}
        <section className="max-w-7xl mx-auto px-md lg:px-lg pt-lg">
          <Alert 
            kind="success" 
        ...
        {/* Admin Section */}
        {hasAdminRole && (
          <section className="max-w-7xl mx-auto px-md lg:px-lg mt-md">
            <Alert 
              kind="info" 
              title="🔐 Admin Access"
            >
        ...
        <section className="py-xl">
          <div className="max-w-7xl mx-auto px-md lg:px-lg">
            <H2 className="mb-lg">Available Features</H2>
            <div className="grid gap-md md:grid-cols-2 lg:grid-cols-3 auto-rows-max">
              {[
                {
        ...
        {/* User Info Section */}
        <section className="max-w-7xl mx-auto px-md lg:px-lg pb-lg">
          <H2 className="mb-lg">Your Profile</H2>
